...
public class TempChartManager {
    ...
    public static void initLineChart(Context context, LineChart mLineChart, ArrayList<String> xValues,
        ...
        //设置折线的样式
        LineDataSet dataSet = new LineDataSet(yValue, "体温曲线图");
...
//        dataSet.enableDashedLine(5f, 5f, 0f);
        ...
        dataSet.setValueFormatter(new TempValueFormatter());
...
//        mLineChart.setMarkerView(mv);
        ...
        xAxis.setValueFormatter(new TempXAxisValueFormatter(xValues));
        //设置是否显示x轴
        ...
        yAxisLeft.setValueFormatter(new TempYAxisValueFormatter());
        yAxisLeft.setEnabled(true);
//        LimitLine limitLine = new LimitLine(37.2f, "");
//        yAxisLeft.addLimitLine(limitLine);
    ...
    private static class TempYAxisValueFormatter implements IAxisValueFormatter {
        @Override
    ...
    private static class TempXAxisValueFormatter implements IAxisValueFormatter {
        ArrayList<String> xValues;

        public TempXAxisValueFormatter(ArrayList<String> xValues) {
    ...
    private static class TempValueFormatter implements IValueFormatter {
        @Override
