...
// */
//
//public class ClinicActivity extends MVPBaseActivity<ClinicContract.Presenter> implements ClinicContract.View,
...
//        //履约测量会传入该参数
//        if (getIntent() != null && getIntent().hasExtra("serviceItem"))
