...
public class TobeTaskPresenter extends TobeTaskContract.Presenter {

    public TobeTaskPresenter(TobeTaskContract.View mView) {
        super(mView);
    }

    @Override
    void loadTobeTask(final ResidentBean resident, int pageIndex) {
        ApiRequest.getResidentTask(resident.getPatientId(), pageIndex).subscribe(new HttpSubscriber() {
            @Override
            public void onError(Throwable e) {
                super.onError(e);
                if (mView != null)
                    mView.loadTobeTaskFailure();
            }
            ...
            public void onNext(HttpResult result) {
                ...
                if (result.code.equals(AppConfig.SUCCESS)) {
                    try {
                        ...
                        if (mView != null)
                            mView.loadTobeTaskSuccess(list);
