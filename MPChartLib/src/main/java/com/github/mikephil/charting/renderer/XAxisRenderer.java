...
//        Utils.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees);
        ...
        float labelInterval = 11f;
        String[] labels = label.split(" ");

        Paint mFirstLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mFirstLinePaint.setColor(0xFF333333);
        ...
        mSecondLinePaint.setColor(0xFF333333);
        ...
        if (labels.length > 1) {
            ...
            Utils.drawXAxisValue(c, label, x, y, mFirstLinePaint, anchor, angleDegrees);
        }
