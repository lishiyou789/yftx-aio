...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    /**
     * if true, the hole will see-through to the aio tips of the slices
     */
    ...
    /**
     * Enable or disable the visibility of the aio tips of the slices behind the hole
     */
    ...
    /**
     * Returns true if the aio tips of the slices are visible behind the hole,
     * false if not.
     *
